...
$page_name = "darq-labs"; ?>
 ...
 <?php require_once('inc/nav.php'); ?>
   <section class="bg-color-0 lab-banner-sec">
    ...
    <section class="bg-color-0 scroll-sec">
        <div class="container-darq">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="txt-48 lh-56 color-white fw-300">Where we can help you</h2>
                        <div class="row align-center">
                            <div class="col-md-6">
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">1</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="txt-18 lh-22 color-white fw-300 d-block pad-0 m-5-auto"><b class="fw-600">Go-to-Market Strategy</b></p>
                                        <p class="txt-16 lh-22 color-white fw-300 d-block">Generate the most optimal outcomes for success when you hit the market, by preparing strategies for messaging, narrative-building, content etc, meticulously supported by our workshops.</p>
                                        </div>
                                        
                                    </div>
                                </div>
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">2</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                ...
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">3</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="txt-18 lh-22 color-white fw-300 d-block pad-0 m-5-auto"><b class="fw-600">Capital-raising Support &amp; Partnerships</b></p>
                                        <p class="txt-16 lh-22 color-white fw-300 d-block">
                                            After investing capital and resources, our portfolio management teams help our companies grow and scale to prepare and successfully raise follow-on funding rounds through our globally-diverse investor network.
                                        </p>
                                        </div>
                                ...
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">4</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="txt-18 lh-22 color-white fw-300 d-block pad-0 m-5-auto"><b class="fw-600">Social, Branding &amp; PR</b></p>
                                        <p class="txt-16 lh-22 color-white fw-300 d-block">
                                            Work with our experts to craft out-of-the box strategies across Marketing &amp; Community Management, PR, Influencer Marketing and more to grow your business and build a loyal community.
                                        </p>
                                        </div>
                                ...
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">5</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="txt-18 lh-22 color-white fw-300 d-block pad-0 m-5-auto"><b class="fw-600">Protocol Participation</b></p>
                                        <p class="txt-16 lh-22 color-white fw-300 d-block">
                                            Staking? Voting? Network Support? We help in whatever way we can to enable protocols accelerate their journey towards complete decentralisation and global-adoption.
                                        </p>
                                        </div>
                                ...
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">6</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="txt-18 lh-22 color-white fw-300 d-block pad-0 m-5-auto"><b class="fw-600">Company-building Support</b></p>
                                        <p class="txt-16 lh-22 color-white fw-300 d-block">
                                            Darq.Labs focuses on accelerating company maturity and growth by drawing from its rich experience across various domains including technology, legal, recruitment and much more.
                                        </p>
                                        </div>
                                ...
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">7</span>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="txt-18 lh-22 color-white fw-300 d-block pad-0 m-5-auto"><b class="fw-600">Infrastructure Support</b></p>
                                        <p class="txt-16 lh-22 color-white fw-300 d-block">
                                            Infrastructure Support Via our network of experts and partners, our portfolio gets access to sound legal, tax, accounting support and more, to take care of various compliances, while they seamless scale by focusing on product and market.
                                        </p>
                                        </div>
                                ...
                                <div class="d-flex lab-scroll">
                                    <span class="big-number color-h-white fw-700 txt-48 d-inline-flex">8</span>
                                    <div class="row">
                                        <div class="col-md-8">
                            ...
                            <div class="col-md-6 text-right globe-col">
                                <div class="globe position-relative"></div>
...
function Mat(){
  var material = new THREE.MeshPhongMaterial({
    color      : new THREE.Color("rgb(200,200,200)"),  //Diffuse color of the material
    emissive   : new THREE.Color("rgb(225,225,225)"), //Emissive(light) color of the material, essentially a solid color unaffected by other lighting. Default is black.
    specular   : new THREE.Color("rgb(255,255,255)"), /*Specular color of the material, i.e., how shiny the material is and the color of its shine. 
